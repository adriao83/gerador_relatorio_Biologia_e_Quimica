...
<style>
    ...
    /* Ocultar botao Gerenciar aplicativo */
    ...
    section[data-testid="stSidebar"] div.stButton { display: none !important; }
...
# --- INTERFACE ---
st.markdown('<div class="header-ufam"><h2>🎓 Relaxa bbzinho(a)! essa IA vai te salvar!!</h2><p>CLCBQ! por Amor! esse é um presente para os meus caros colegas de estagio. tmj! att: sr_vngls_adrião</p></div>', unsafe_allow_html=True)
